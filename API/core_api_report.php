												  ...
												  if($parameter_sql != ''){
														...
														if($thnFix < $thnIntraDefault){
															...
															$query_01 = "select SUM(T.NilaiPerolehan) as Nilai,
																			...
																			T.kodeSatker,T.kodeKelompok, T.Tahun,T.NilaiPerolehan, T.AsalUsul,T.Info, T.TglPerolehan,T.TglPembukuan,T.Alamat,T.LuasTotal,T.HakTanah, T.NoSertifikat, T.TglSertifikat, T.Penggunaan,T.kodeRuangan,T.kodeLokasi,T.kondisi,
																			K.Kode, K.Uraian
																		from 
																			tanahView as T,kelompok as K
																		where
															...
															$query_02_condt = "select  SUM(M.NilaiPerolehan) as Nilai,
																		...
																		where 
																			M.kodeKelompok=K.Kode  
																			 and M.Status_Validasi_Barang =1 and M.StatusTampil =1 and (M.NilaiPerolehan >= 0 $KodeKa_mesin) AND M.kodeLokasi like '12%'
																			AND $extQuery_B_cndt 
																		group by 
																			M.kodeSatker,M.kodeKelompok,M.NilaiPerolehan, M.AsalUsul, M.Info, M.TglPerolehan,M.TglPembukuan,
																			M.Tahun,M.Alamat, M.Merk,M.Ukuran,M.Material,M.NoSeri, M.NoRangka,M.NoMesin,M.NoSTNK,M.NoBPKB,M.Silinder,
															...
															$query_03_condt = "select SUM(B.NilaiPerolehan) as Nilai,
																	...
																	where
																		B.kodeKelompok = K.Kode 
																		 and B.Status_Validasi_Barang = 1 and B.StatusTampil =1 and (B.NilaiPerolehan >= 0 $KodeKa_bangunan) AND B.kodeLokasi like '12%'
																		AND $extQuery_C_cndt
																	group by 
																		B.kodeSatker,B.kodeKelompok,B.NilaiPerolehan, B.AsalUsul,
																		B.Info, B.TglPerolehan,B.TglPembukuan,B.Tahun,B.Alamat,
													...
													if($parameter_sql != ''){
														...
														if($thnceck >= $thnExtraDefault){
															...
															$query_02 = "select SUM(M.NilaiPerolehan) as Nilai,GROUP_CONCAT(M.noRegister) as noReg,
																		...
																		where 
																			M.kodeKelompok=K.Kode  
																			 and M.Status_Validasi_Barang =1 and M.StatusTampil =1 and (M.NilaiPerolehan < 0 $KodeKa_mesin)
															...
															$query_03 = "select SUM(B.NilaiPerolehan) as Nilai,GROUP_CONCAT(B.noRegister) as noReg, 
																	...
																	where
																		B.kodeKelompok = K.Kode 
																		 and B.Status_Validasi_Barang = 1 and B.StatusTampil =1 and (B.NilaiPerolehan < 0 $KodeKa_bangunan)
						...
						if($paramGol == 01 ){
							...
							if($thnFix < $thnDefault){
								...
								$queryok ="select m.kodeKelompok,k.Uraian,count(m.Aset_ID) as jumlah,sum(m.NilaiPerolehan) as Nilai,
								   ...
								   and (m.NilaiPerolehan >=0 $KodeKa_m_2) and m.Status_Validasi_Barang =1 and m.StatusTampil = 1 and m.kodeLokasi like '12%' and m.kodeLokasi like '12%' 
								...
								$queryok ="select m.kodeKelompok,k.Uraian,count(m.Aset_ID) as jumlah,sum(m.NilaiPerolehan) as Nilai,
									   ...
									   and (m.NilaiPerolehan >=0 $KodeKa_m_2) and m.Status_Validasi_Barang =1 and m.StatusTampil = 1 and m.kodeLokasi like '12%' 
							...
							if($thnFix < $thnDefault){
								...
								$queryok ="SELECT k.Uraian, b.Alamat, b.LuasLantai, b.NilaiPerolehan,b.PenyusutanPerTahun,b.AkumulasiPenyusutan,b.NilaiBuku
										...
										and (b.NilaiPerolehan >=0 $KodeKa_b_2) and b.kondisi != '3' and b.kondisi != 4 and b.Status_Validasi_Barang =1 and b.StatusTampil = 1 and b.kodeLokasi like '12%'";
							}else{
								$queryok ="SELECT k.Uraian, b.Alamat, b.LuasLantai, b.NilaiPerolehan,b.PenyusutanPerTahun,b.AkumulasiPenyusutan,b.NilaiBuku
									FROM bangunan_ori as b, kelompok as k 
						...
						{	
							...
							if($thnFix  < $thnDefault){
								if($data2 == '01.01'){
									...
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
													sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NB 
													jumlah FROM bangunan_ori WHERE kodeKelompok like '$data2%' and $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <='$tglAkhirDefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1 $KodeKaCondt1";
								}elseif($data2 == '04.13' || $data2 == '04.14' || $data2 == '04.15' || $data2 == '04.16'){
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
													sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NB 
													FROM jaringan_ori WHERE kodeKelompok like '$data2%' and $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <='$tglAkhirDefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1";
								...
								if($data2 == '01.01'){
									...
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
													sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NB 
													FROM mesin_ori WHERE kodeKelompok like '$data2%' and $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <='$tglAkhirDefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and NilaiPerolehan >=0 and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1 $KodeKaCondt1";
								}elseif($data2 == '03.11' || $data2 == '03.12'){
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
													sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NB 
									...
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah FROM aset_lain_3 WHERE $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <='$tglAkhirDefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and (kondisi ='3' or kondisi ='4') and Status_Validasi_Barang =1  
												   $KodeKaCondt1 and kodeKelompok not like '07.24%'";
								}elseif($data2 == '07.24'){
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah FROM aset_lain_3 WHERE kodeKelompok like '$data2%'  and $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <='$tglAkhirDefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi ='3' and Status_Validasi_Barang =1  
												   $KodeKaCondt1";
									//	Status_Validasi_Barang = 1
								...
								if($data2 == '01.01'){
									...
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
													sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NB 
													FROM mesin_ori WHERE kodeKelompok like '$data2%' and $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <'$tgldefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1 
													$KodeKaCondt1
													UNION ALL
													...
													and (NilaiPerolehan >=0 $KodeKa) and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1 ";
								}elseif($data2 == '03.11' || $data2 == '03.12'){
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
												sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NB 
												FROM bangunan_ori WHERE kodeKelompok like '$data2%' and $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <'$tgldefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1 
												$KodeKaCondt1
												UNION ALL
												SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
												sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NB 
									...
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah FROM aset_lain_3 WHERE $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <='$tglAkhirDefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' 
												   and (kondisi ='3' or kondisi ='4') and Status_Validasi_Barang =1  $KodeKaCondt1
												   and kodeKelompok not like '07.24%'";
									//	Status_Validasi_Barang = 1
								}elseif($data2 == '07.24'){
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah FROM aset_lain_3 WHERE kodeKelompok like '$data2%'  and $paramSatker and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <='$tglAkhirDefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi ='3' and Status_Validasi_Barang =1  $KodeKaCondt1";
									//	Status_Validasi_Barang = 1
						...
						{	
							...
							if($thnFix  < $thnDefault){
								if($data2 == '01.01'){
									...
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah 
													sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NilaiBuku 
													FROM jaringan_ori WHERE kodeKelompok like '$data2%' and kodeSatker like '$Satker_ID%' and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <='$tglAkhirDefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1";
								}elseif($data2 == '05.17' || $data2 == '05.18' || $data2 == '05.19'){
								...
								if($data2 == '01.01'){
									...
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
													sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NilaiBuku 
													FROM mesin_ori WHERE kodeKelompok like '$data2%' and kodeSatker  like '$Satker_ID%' and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <'$tgldefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1 
													$KodeKaCondt1
													UNION ALL
													SELECT sum(NilaiPerolehan) as nilai,count(Aset_ID) as jumlah,
													sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NilaiBuku 
									...
									$queryresult ="SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
												sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NilaiBuku 
												FROM bangunan_ori WHERE kodeKelompok like '$data2%' and kodeSatker like '$Satker_ID%' and kodeLokasi like '12%' and TglPerolehan >='$tglAwalDefault' and TglPerolehan <'$tgldefault' and TglPembukuan >='$tglAwalDefault' and TglPembukuan <='$tglAkhirDefault' and kondisi !='3' and kondisi != 4 and Status_Validasi_Barang =1 and StatusTampil = 1 
												$KodeKaCondt1
												UNION ALL
												SELECT sum(NilaiPerolehan) as nilai, count(Aset_ID) as jumlah,
												sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NilaiBuku 
	...
	public function barangskpd($satker_id,$tglawalperolehan,$tglakhirperolehan){
		...
		foreach ($satker as $data=>$satker_id){
			...
			$query_02_condt_1 = "SELECT sum(NilaiPerolehan) as nilai,
							...
							and TglPembukuan >= '$tglAwalDefault' AND TglPembukuan <= '$tglAkhirDefault' 
							and Status_Validasi_Barang =1 and StatusTampil = 1 and kodeLokasi like '12%'
							and (NilaiPerolehan >= 0 $KodeKa) and kondisi != 3 and kondisi != 4";
			//modif				
...
//								where $paramPnghpsn";
	...
	//test aja semoga berhasil
	public function custome($satker_id,$tglawalperolehan,$tglakhirperolehan)
	{
		//pr($_SESSION);
		$user = $_SESSION['ses_uoperatorid'];
		# code for get list satker
		//pr($satker_id);
		if($satker_id){
			$splitKodeSatker = explode ('.',$satker_id);
			//pr($splitKodeSatker);
		...
		//delete data first to other request with same user
		$sql_del_ALl = "DELETE FROM report_upb WHERE  user = '{$user}'";
		$exe_del_ALl = $this->query($sql_del_ALl); 
		//exit;	
		foreach ($satker as $key => $value) {
			#drop view table
			$sql_view_table_A = "DROP TEMPORARY TABLE tanahView";
			$exeview_table_A = $this->query($sql_view_table_A); 
			
			$sql_view_table_B = "DROP TEMPORARY TABLE mesin_ori";
			$exeview_table_B = $this->query($sql_view_table_B); 
			
			$sql_view_table_B2 = "DROP TEMPORARY TABLE mesin_Rplctn";
			$exeview_table_B2 = $this->query($sql_view_table_B2); 

			$sql_view_table_C = "DROP TEMPORARY TABLE bangunan_ori";
			$exeview_table_C = $this->query($sql_view_table_C); 
			
			$sql_view_table_C2 = "DROP TEMPORARY TABLE bangunan_Rplctn";
			$exeview_table_C2 = $this->query($sql_view_table_C2); 

			$sql_view_table_D = "DROP TEMPORARY TABLE jaringan_ori";
			$exeview_table_D = $this->query($sql_view_table_D); 
			
			$sql_view_table_E = "DROP TEMPORARY TABLE asetlain_ori";
			$exeview_table_E = $this->query($sql_view_table_E); 
			
			$sql_view_table_F = "DROP TEMPORARY TABLE kdp_ori";
			$exeview_table_F = $this->query($sql_view_table_F); 
			# code param temp table
			$paramSatker_mts_tr = "SatkerTujuan = '$value'";
			$paramSatker = "kodeSatker = '$value'";
			...
			$AllTableTemp_A = array($queryKibA,$queryAlterA,$queryLogA,$queryMutasiA);
			
			for ($i = 0; $i < count($AllTableTemp_A); $i++){
					// exit;
					$resultQuery = $this->query($AllTableTemp_A[$i]) or die ($this->error('error dataQuery'));
			}

			//select Insert data
			$query_tanah = "SELECT sum(NilaiPerolehan) as nilai FROM tanahView
							WHERE kodeSatker = '$value'  
							and TglPerolehan >= '$tglAwalDefault' AND TglPerolehan <= '$tglAkhirDefault' 
							and TglPembukuan >= '$tglAwalDefault' AND TglPembukuan <= '$tglAkhirDefault' 
							and Status_Validasi_Barang =1 and StatusTampil = 1 and kodeLokasi like '12%' and kondisi !='3' and kondisi != '4'";
			//pr($query_tanah);				
			$result = $this->query($query_tanah) or die ($this->error('error dataQuery'));
			...
			if($result){
				...
				while ($dataAll = $this->fetch_object($result)){
					...
					//set manual data	
					$kodeSatker = "$value";
					//$kodeUser 	= $_SESSION['$ses_uoperatorid'];
					if($dataAll->nilai == NULL || $dataAll->nilai == ''){
						$nilai = 0;
					}else{
						$nilai = $dataAll->nilai;
			...
			$AllTableTemp_B = array($queryKibB,$queryAlterB,$queryLogB,$queryMutasiB,
									$queryKibB_Rplctn,$queryAlterB_Rplctn,$queryLogB_Rplctn,$queryMutasiB_Rplctn
									);
			
			for ($i = 0; $i < count($AllTableTemp_B); $i++){
					// exit;
					$resultQuery_B = $this->query($AllTableTemp_B[$i]) or die ($this->error('error dataQuery'));
			}
			...
			if($thnFix < $thnDefault){
				// echo "tahun kurang dari 2008";
				$queryALL_B = $query_02_default;
			}elseif($thnceck >= $thnDefault){
				// echo "tahun diatas dari 2008";
				$queryALL_B = $query_02_condt_1;
			}else{
				// echo "<2008 >2008";
				$queryALL_B = $query_02_condt_2;
			}
			
			//pr($queryALL_B);				
			$result_B = $this->query($queryALL_B) or die ($this->error('error dataQuery'));

			if($result_B){
				// $i = 0;
				while ($dataAll_B = $this->fetch_object($result_B)){
					//pr($dataAll_B);
					//set manual data	
					$kodeSatker = "$value";
					//$kodeUser 	= $_SESSION['$ses_uoperatorid'];
					
					if($dataAll_B->nilai == NULL || $dataAll_B->nilai == ''){
						$nilai = 0;
					}else{
						$nilai = $dataAll_B->nilai;
					}
					
					if($dataAll_B->NilaiPP == NULL || $dataAll_B->NilaiPP == ''){
						$nilaiPP = 0;
					}else{
						$nilaiPP = $dataAll_B->NilaiPP;
					}
			
					if($dataAll_B->NilaiAP == NULL || $dataAll_B->NilaiAP == ''){
						$nilaiAP = 0;
						$nilaiBK = $nilai;
					}else{
						$nilaiAP = $dataAll_B->NilaiAP;
						$nilaiBK = $dataAll_B->NB;
					}
			
					/*if($dataAll_B->NB == NULL || $dataAll_B->NB == ''){
						$nilaiBK = 0;
					}else{
						$nilaiBK = $dataAll_B->NB;
					}*/
			...
			$AllTableTemp_C = array($queryKibC,$queryAlterC,$queryLogC,$queryMutasiC,
									$queryKibC_Rplctn,$queryAlterC_Rplctn,$queryLogC_Rplctn,$queryMutasiC_Rplctn
									);
			
			for ($i = 0; $i < count($AllTableTemp_C); $i++){
					$resultQuery_C = $this->query($AllTableTemp_C[$i]) or die ($this->error('error dataQuery'));
			}
			...
			$query_03_condt_1 = "SELECT sum(NilaiPerolehan) as nilai,
						sum(PenyusutanPerTahun) as NilaiPP,sum(AkumulasiPenyusutan) as NilaiAP,sum(NilaiBuku) as NB 
						FROM bangunan_ori
						WHERE $kodeKelompok kodeSatker = '$value'  
						and TglPerolehan >= '$tglAwalDefault' AND TglPerolehan <= '$tglAkhirDefault' 
						and TglPembukuan >= '$tglAwalDefault' AND TglPembukuan <= '$tglAkhirDefault' 
						and Status_Validasi_Barang =1 and StatusTampil = 1 and kodeLokasi like '12%'
						and (NilaiPerolehan >= 0 $KodeKa) 
			...
			if($thnFix < $thnDefault){
				// echo "tahun kurang dari 2008";
				$queryALL_C = $query_03_default;
			}elseif($thnceck >= $thnDefault){
				// echo "tahun diatas dari 2008";
				$queryALL_C = $query_03_condt_1;
			}else{
				// echo "<2008 >2008";
				$queryALL_C = $query_03_condt_2;
			}
			
			//pr($queryALL_C);				
			$result_C = $this->query($queryALL_C) or die ($this->error('error dataQuery'));

			if($result_C){
				// $i = 0;
				while ($dataAll_C = $this->fetch_object($result_C)){
					//pr($dataAll_C);
					//set manual data	
					$kodeSatker = "$value";
					//$kodeUser 	= $_SESSION['$ses_uoperatorid'];
					
					if($dataAll_C->nilai == NULL || $dataAll_C->nilai == ''){
						$nilai = 0;
					}else{
						$nilai = $dataAll_C->nilai;
					}
					
					if($dataAll_C->NilaiPP == NULL || $dataAll_C->NilaiPP == ''){
						$nilaiPP = 0;
					}else{
						$nilaiPP = $dataAll_C->NilaiPP;
					}
			
					if($dataAll_C->NilaiAP == NULL || $dataAll_C->NilaiAP == ''){
						$nilaiAP = 0;
						$nilaiBK = $nilai;
					}else{
						$nilaiAP = $dataAll_C->NilaiAP;
						$nilaiBK = $dataAll_C->NB;
					}
					
					/*if($dataAll_C->NB == NULL || $dataAll_C->NB == ''){
						$nilaiBK = 0;
					}else{
						$nilaiBK = $dataAll_C->NB;
					}*/
			...
			$AllTableTemp_D = array($queryKibD,$queryAlterD,$queryLogD,$queryMutasiD);
			
			for ($i = 0; $i < count($AllTableTemp_D); $i++){
					$resultQuery_D = $this->query($AllTableTemp_D[$i]) or die ($this->error('error dataQuery'));
			}
			...
			//pr($queryALL_C);				
			$result_D = $this->query($queryALL_D) or die ($this->error('error dataQuery'));

			if($result_D){
				// $i = 0;
				while ($dataAll_D = $this->fetch_object($result_D)){
					//pr($dataAll_C);
					//set manual data	
					$kodeSatker = "$value";
					//$kodeUser 	= $_SESSION['$ses_uoperatorid'];
					
					if($dataAll_D->nilai == NULL || $dataAll_D->nilai == ''){
						$nilai = 0;
					}else{
						$nilai = $dataAll_D->nilai;
					}
					
					if($dataAll_D->NilaiPP == NULL || $dataAll_D->NilaiPP == ''){
						$nilaiPP = 0;
					}else{
						$nilaiPP = $dataAll_D->NilaiPP;
					}
			
					if($dataAll_D->NilaiAP == NULL || $dataAll_D->NilaiAP == ''){
						$nilaiAP = 0;
						$nilaiBK = $nilai;
					}else{
						$nilaiAP = $dataAll_D->NilaiAP;
						$nilaiBK = $dataAll_D->NB;
					}
					
					/*if($dataAll_D->NB == NULL || $dataAll_D->NB == ''){
						$nilaiBK = 0;
					}else{
						$nilaiBK = $dataAll_D->NB;
					}*/
			...
			$AllTableTemp_E = array($queryKibE,$queryAlterE,$queryLogE,$queryMutasiE);
			
			for ($i = 0; $i < count($AllTableTemp_E); $i++){
					$resultQuery_E = $this->query($AllTableTemp_E[$i]) or die ($this->error('error dataQuery'));
			}
			$query_05 = "SELECT sum(NilaiPerolehan) as nilai FROM asetlain_ori
				WHERE kodeSatker = '$value'  
				and TglPerolehan >= '$tglAwalDefault' AND TglPerolehan <= '$tglAkhirDefault'
			...
			//pr($queryALL_C);				
			$result_E = $this->query($queryALL_E) or die ($this->error('error dataQuery'));

			if($result_E){
				// $i = 0;
				while ($dataAll_E = $this->fetch_object($result_E)){
					//pr($dataAll_C);
					//set manual data	
					$kodeSatker = "$value";
					//$kodeUser 	= $_SESSION['$ses_uoperatorid'];
					
					if($dataAll_E->nilai == NULL || $dataAll_E->nilai == ''){
						$nilai = 0;
					}else{
						$nilai = $dataAll_E->nilai;
					}
					
					if($dataAll_E->NilaiPP == NULL || $dataAll_E->NilaiPP == ''){
						$nilaiPP = 0;
					}else{
						$nilaiPP = $dataAll_E->NilaiPP;
					}
			
					if($dataAll_E->NilaiAP == NULL || $dataAll_E->NilaiAP == ''){
						$nilaiAP = 0;
						$nilaiBK = $nilai;
					}else{
						$nilaiAP = $dataAll_E->NilaiAP;
						$nilaiBK = $dataAll_E->NB;
					}
					
					/*if($dataAll_E->NB == NULL || $dataAll_E->NB == ''){
						$nilaiBK = 0;
					}else{
						$nilaiBK = $dataAll_E->NB;
					}*/
			...
			$AllTableTemp_F = array($queryKibF,$queryAlterF,$queryLogF,$queryMutasiF);
			
			for ($i = 0; $i < count($AllTableTemp_F); $i++){
					$resultQuery_F = $this->query($AllTableTemp_F[$i]) or die ($this->error('error dataQuery'));
			}
			...
			//pr($queryALL_C);				
			$result_F = $this->query($queryALL_F) or die ($this->error('error dataQuery'));

			if($result_F){
				// $i = 0;
				while ($dataAll_F = $this->fetch_object($result_F)){
					//pr($dataAll_C);
					//set manual data	
					$kodeSatker = "$value";
					//$kodeUser 	= $_SESSION['$ses_uoperatorid'];
					
					if($dataAll_F->nilai == NULL || $dataAll_F->nilai == ''){
						$nilai = 0;
					}else{
						$nilai = $dataAll_F->nilai;
					}
					
					if($dataAll_F->NilaiPP == NULL || $dataAll_F->NilaiPP == ''){
						$nilaiPP = 0;
					}else{
						$nilaiPP = $dataAll_F->NilaiPP;
					}
			
					if($dataAll_F->NilaiAP == NULL || $dataAll_F->NilaiAP == ''){
						$nilaiAP = 0;
						$nilaiBK = $nilai;
					}else{
						$nilaiAP = $dataAll_F->NilaiAP;
						$nilaiBK = $dataAll_F->NB;
					}
					
					/*if($dataAll_F->NB == NULL || $dataAll_F->NB == ''){
						$nilaiBK = 0;
					}else{
						$nilaiBK = $dataAll_F->NB;
					}*/
