...
$newTahun = $tahun ; 
// $newTahun = $tahun - 1; 
$aColumns = array('a.kodeSatker','a.Aset_ID','a.kodeKelompok','k.Uraian','a.Tahun','a.Info','a.NilaiPerolehan','a.noRegister','a.PenyusutanPerTahun','a.AkumulasiPenyusutan','a.TipeAset','a.kodeSatker','a.Status_Validasi_Barang');
  ...
  fclose($myfile);
    ...
    $queryKib 		= "create temporary table aset_tmp as
                                      select a.Mesin_ID,a.Aset_ID, a.kodeKelompok, a.kodeSatker, a.kodeLokasi, a.noRegister, a.TglPerolehan, a.TglPembukuan, a.kodeData, a.kodeKA, 'TipeAset',
                                            ...
                                            from mesin a where a.TglPerolehan <= '$newTahun-12-31'  and a.Aset_Id in ($aset_id_cek) ";
    ...
    $queryLog 		= "replace into aset_tmp (Mesin_ID, Aset_ID, kodeKelompok, kodeSatker, kodeLokasi, noRegister, TglPerolehan, TglPembukuan, kodeData, kodeKA, TipeAset,
                                                 ...
                                                 where  (a.Kd_Riwayat != '77' AND a.Kd_Riwayat != '0')  and a.Aset_Id in ($aset_id_cek)  and a.TglPerolehan <= '$newTahun-12-31' and a.TglPerubahan>'$TglPerubahan_temp'"
         ...
         //untuk table selanjutnya
          $queryKib 		= "create temporary table aset_tmp2 as
                                      select a.Mesin_ID,a.Aset_ID, a.kodeKelompok, a.kodeSatker, a.kodeLokasi, a.noRegister, a.TglPerolehan, a.TglPembukuan, a.kodeData, a.kodeKA, 'TipeAset',
                                                  ...
                                                  a.NoRangka, a.NoMesin, a.NoSTNK, a.TglSTNK, a.NoBPKB, a.TglBPKB, a.NoDokumen, a.TglDokumen, a.Pabrik, a.TahunBuat, a.BahanBakar, 
                                                  a.NegaraAsal, a.NegaraRakit, a.Kapasitas, a.Bobot, a.GUID, a.MasaManfaat, a.AkumulasiPenyusutan, a.NilaiBuku, a.PenyusutanPerTahun 
                                            from mesin a where  A.Aset_Id in ($aset_id_cek)  and  a.TglPerolehan <= '$newTahun-12-31' ";
    $ExeQuery = $DBVAR->query($queryKib) or die($DBVAR->error());
 ...
 where a.TglPerolehan <='$newTahun-12-31' AND a.TglSKKDH >'$newTahun-12-31' AND "
  ...
  fclose($myfile);
     	...
     	$queryKib 		= "create temporary table aset_tmp  as
                                                 ...
                                                 from bangunan a
                                                 where  A.Aset_Id in ($aset_id_cek)  and a.TglPerolehan <= '$newTahun-12-31'";
      $ExeQuery = $DBVAR->query($queryKib) or die($DBVAR->error());
...
echo "Penyusutan tahun pertama $kodeSatker \n"
        . "Aset_ID \t kodeSatker \t kodeKelompok  \t NilaiPerolehan \t Tahun \t masa_manfaat \t AkumulasiPenyusutan \t NilaiBuku  \t penyusutan_per_tahun \n";
                   
while($Data = $DBVAR->fetch_array($ExeQuery)){
		$Aset_ID = $Data['Aset_ID'];
		$kode_satker_revisi=$Data['kodeSatker'];
		...
		if ($masa_manfaat!=""){
				   ...
				   if($rentang_tahun_penyusutan>=$masa_manfaat){
					...
					//untuk log txt
					echo "$Aset_ID \t $kode_satker_revisi \t $kodeKelompok \t $NilaiPerolehan \t $Tahun \t $masa_manfaat \t $AkumulasiPenyusutan \t $NilaiBuku  \t $penyusutan_per_tahun \n";
