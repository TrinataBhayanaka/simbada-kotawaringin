...
$get_data_penyusutan= $PENYUSUTAN->getStatusPenyusutansatker_berjalan($param,2015);
//echo "masukk gak";
// echo "<pre>";
...
<section id="main">
	<ul class="breadcrumb">
	  ...
	  <li><a href="#">Penyusutan Tahun Berjalan (Revisi 2006)</a><span class="divider"><b>&raquo;</b></span></li>
	  <li class="active">Status Penyusutan Aset</li>
	  <?php SignInOut();?>
	</ul>
	<div class="breadcrumb">
		<div class="title">Daftar Penyusutan Tahun Berjalan (Revisi 2006)</div>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			...
			switch ($val['StatusRunning']) {
				case 0:
					// $tahun = date('Y');
					// if($val['Tahun'] == $tahun){
					echo "<a href=\"running_penyusutan_kedua.php?id={$val['id']}\" class=\"btn btn-warning\">Lakukan Penyusutan</a>";
					// }
					break;
				case 2:
					// $tahun = date('Y');
					// if($val['Tahun'] == $tahun){
						echo "<a href=\"running_batal_penyusutan_kedua.php?id={$val['id']}\" class=\"btn btn-danger\">Batal Penyusutan</a>";
					// }
					break;
			default:
				 echo "-";
