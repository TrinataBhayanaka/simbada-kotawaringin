...
$newTahun = $tahun;
echo "$kib $tahun $kodeSatker $id";
$aColumns = array('a.Aset_ID', 'a.kodeKelompok', 'k.Uraian', 'a.Tahun', 'a.Info', 'a.NilaiPerolehan', 'a.noRegister', 'a.PenyusutanPerTahun', 'a.AkumulasiPenyusutan', 'a.TipeAset', 'a.kodeSatker', 'a.Status_Validasi_Barang','a.TahunPenyusutan');
...
while ($Data = $DBVAR->fetch_array($ExeQuery)) {
    ...
    //untuk ngecek tahun penyusutan
    $tahun=$TahunPenyusutan;
    if($tahun==0){
        echo "masuk tahun=0000 untuk ASET_ID=$Aset_ID===$TahunPenyusutan\n";
        $tahun=2014;
    }
