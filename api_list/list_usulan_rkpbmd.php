...
while ($aRow = $DBVAR->fetch_array($rResult)) {
	...
	$cetak="<a style=\"display:display\"  
			href=\"$url_rewrite/report/template/PERENCANAAN/rencana_usulan_pemeliharaan_aset.php?idus={$idus}&satker={$kodeSatker}\"	class=\"btn btn-warning btn-small\" id=\"\" value=\"\" >
