...
$aColumns = array('idr','idus','kodeKelompok','jml_usul','jml_max','jml_optml','jml_rill','jml_usul_rev','jml_max_rev','jml_rill_rev');
//$test = count($aColumns);
...
while ($aRow = $DBVAR->fetch_array($rResult)) {
	...
	$edit="<a style=\"display:display\"  
			href=\"edit_penetapan_aset.php?idr={$idr}&idus={$idus}&tgl_usul={$param_tgl_usul}&satker={$satker}\"	class=\"btn btn-warning btn-small\" id=\"\" value=\"\" >
			 
			<i class=\"fa fa-pencil\" align=\"center\"></i>&nbsp;&nbsp;Edit</a>";

	  $row[] ="<center>".$no."<center>";
	  $row[] ="[".$kodeKelompok."] ".$ket['Uraian'];
