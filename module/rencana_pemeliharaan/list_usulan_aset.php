		...
		<section class="formLegend">
				...
				<ul>
					<li>
						<?php
							...
							?>
								<a style="display:display"  href="tambah_usulan_aset.php?idus=<?=$idus?>&satker=<?=$satker?>" class="btn btn-info btn-small" id=""><i class="icon-plus-sign icon-white" align="center"></i>&nbsp;&nbsp;Tambah Usulan Aset</a>	
							<?php
							}else{
								//nothing
							}
					...
					<li>
						<span class="labelInfo">Output</span>
						<input type="text" class="span5" value="<?=$dataKetOutput['kd_output']." ".$dataKetOutput['output'] ?>" disabled/>
					</li>
					<li>
			...
			<div class="detailRight">
				<ul>
					...
					<li>
						<a id="" class="btn btn-small" href="index.php?satker=<?=$satker?>" >
