...
//ceck fisrst
$count = mysql_query("select count(idr) as jml from usulan_rencana_pemeliharaan_aset where idus = '{$idus}'");
...
//delete program
$query ="delete from usulan_rencana_pemeliharaan where idus = '$idus'"; 
