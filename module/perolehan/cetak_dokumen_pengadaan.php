		...
		<section class="formLegend">
			...
			<div class="tabbable" style="margin-bottom: 18px;">
					  <ul class="nav nav-tabs">
						...
						<li><a href="#takberwujud" data-toggle="tab">Daftar Aset Tidak Berwujud</a></li>
					  ...
					  <li><a href="#rekaprincianbarangmutasi" data-toggle="tab">Rekapitulasi Rincian Mutasi Barang </a></li>
                          ...
                          <li><a href="#rekap_detail_dinaspendidikan" data-toggle="tab">Rincian Detail Dinas Pendidikan</a></li>
					  </ul>
					  ...
					  <div class="tab-content" style="padding-bottom: 9px; border-bottom: 1px solid #ddd;">
						...
						<div class="tab-pane" id="takberwujud">
						<div class="breadcrumb">
							<div class="titleTab">Daftar Aset Tidak Berwujud</div>
						</div>
						 <form method="post" name="form" action="<?php echo "$url_rewrite/report/template/PEROLEHAN/takberwujud.php"; ?>">
						<ul>
							<li>
								<span class="span2">Tanggal Awal</span>
								<div class="control">
									<div class="input-prepend">
										<span class="add-on"><i class="fa fa-calendar"></i></span>
										<input type="text" class="span2 full" name="tglPerolehanAwalTbwjd" id="tglPerolehanAwalTbwjd" value="" />
									</div>
								</div>
							</li>
							<li>
								...
								<div class="control">
									<div class="input-prepend">
										<span class="add-on"><i class="fa fa-calendar"></i></span>
										<input type="text" class="span2 full" name="tglPerolehanAkhirTbwjd" id="tglPerolehanAkhirTbwjd" value="" required/>
									</div>
								</div>
							</li>
							<?php //selectAllSatker('kodeSatker7','255',true,false); 
						...
						<ul>
                          ...
                          <div class="tab-pane" id="rekap_detail_dinaspendidikan">
                              <div class="breadcrumb">
                                  <div class="titleTab">Rekapitulasi Detail Rincian Barang Mutasi (sampai ke no-register)</div>
                              </div>
                              <form method="post" name="form" action="<?php echo "$url_rewrite/report/template/PEROLEHAN/rekapdetailrincianbarangmutasi_pendidikan.php"; ?>">
                                  <ul>
                                      <li>
                                          <span class="span2">Tanggal Awal</span>
                                          <div class="control">
                                              <div class="input-prepend">
                                                  <span class="add-on"><i class="fa fa-calendar"></i></span>
                                                  <input type="text" class="span2 full" name="tglPerolehanAwalRekapNeraca" id="tglPerolehanAwalRekapNeraca1Pendidikan" value="" readonly="1"/>
                                              </div>
                                          </div>
                                      </li>
                                      <li>
                                          ...
                                          <div class="control">
                                              <div class="input-prepend">
                                                  <span class="add-on"><i class="fa fa-calendar"></i></span>
                                                  <input type="text" class="span2 full" name="tglPerolehanAkhirRekapNeraca" id="tglPerolehanAkhirRekapNeraca1Pendidikan" value="" required/>
                                              </div>
                                          </div>
                                      </li>
                                      <li>
                                      ...
                                      selectAllSatker('kodeSatkerRincian203','255',true,false,false,true);
