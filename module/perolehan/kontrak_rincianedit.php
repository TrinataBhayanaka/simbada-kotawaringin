				 ...
				 <div class="formKontrak">
						...
						<ul>
							...
							<li>
								...
								<input type="text" class="span3" name="Kuantitas" id="jumlah" value="<?=($kontrak[0]['tipeAset'] == 3 || $_GET['tipeaset'] == 'kdp')? 1 : ''?>" onchange="return totalHrg()" required <?=($_GET['tipeaset'] == 'kdp')? readonly : ''?>/>
							</li>
							<li>
