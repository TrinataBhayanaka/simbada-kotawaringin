							...
							<li>
								...
								<div class="control">
									<div class="input-prepend">
										...
										<input type="text" class="span2 datepicker" placeholder="yyyy-mm-dd" id="datepicker" name="TglPerolehan" value="<?=($kontrak[0]['tipeAset'] == '3')? $aset[0]['TglPerolehan'] : ''?>" <?=($kontrak[0]['tipeAset'] == '3')? readonly : ''?> required/>
									</div>
								</div>
							</li>
							<li>
