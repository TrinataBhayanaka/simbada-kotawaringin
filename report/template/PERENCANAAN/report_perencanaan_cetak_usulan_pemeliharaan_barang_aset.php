...
if($tipe == 1){
			 ...
			 cellpadding=\"2\" cellspacing=\"2\">
			  <tbody>
				<tr>
				  ...
				  <h3>USULAN RENCANA KEBUTUHAN PEMELIHARAAN BARANG MILIK DAERAH</h3>
	...
	$head = "<table style=\"text-align: center; width: 100%;\" border=\"0\"
			 cellpadding=\"0\" cellspacing=\"0\">
			  <tbody>
				<tr>
					<td><p>USULAN RENCANA KEBUTUHAN PEMELIHARAAN BARANG MILIK DAERAH</p></td>
				</tr>
				<tr>
...
$paramSql = "u.idus = '$idus'";
$paramStatus =" AND u.status_usulan = 1";
...
foreach ($list as $ky => $vl) {
	...
	$data[$vl['KDPROGRAM'].'-'.$vl['KDGIAT'].'-'.$vl['KDOUTPUT'].'-'.$vl['kodeKelompok']]['jml_max_rev'] = $vl['jml_max'];
...
$namafile="$path/report/output/Rencana_Usulan_Pengadaan_$waktu.pdf";
$mpdf->Output("$namafile",'F');
$namafile_web="$url_rewrite/report/output/Rencana_Usulan_Pengadaan_$waktu.pdf";
...
{
	$waktu=date("d-m-y_h:i:s");
	$filename ="Rencana_Usulan_Pengadaan_$waktu.xls";
