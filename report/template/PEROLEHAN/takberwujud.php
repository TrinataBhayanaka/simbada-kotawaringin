...
$tglawalperolehan = $_REQUEST['tglPerolehanAwalTbwjd'];
$tglakhirperolehan = $_REQUEST['tglPerolehanAkhirTbwjd'];
...
$url = "report_perolehanaset_cetak_aset_takberwujud.php?$paramater_url";
